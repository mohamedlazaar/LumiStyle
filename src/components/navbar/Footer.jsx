...
function Footer() {
  return (
        <footer className="bg-black text-white text-center p-4 pt-10">
            <div className="container flex flex-col md:flex-row  justify-between px-10 pb-8">
             ...
             <ul className='flex flex-col gap-6 text-sm font-medium items-start    sm:gap-4   '>
                <li><h2 className='underline'>Main Menu</h2></li>
             ...
             <div className="flex">
              <ul className='flex flex-col gap-6 text-sm font-medium items-start    sm:gap-4    '>
                <li><h2 className='underline'>Contactez-nous</h2></li>
            ...
            <div className="text-center text-sm text-gray-400 p-4 " style={{borderTop:'1px solid #fff'}}>
              <p>&copy; 2023 Lumi Style. All rights reserved. || Site realise par: <a href="https://www.linkedin.com/in/mohamed-lazaar/" className='decoration-none text-blue-500 hover:text-blue-800 transition-all ' target="_blank" rel="noopener noreferrer">
                Mohamed Lazaar
                </a></p>
              </div>
