  ...
  return (
    <div className='bg-yellow-500 pt-5 pb-10'>
          ...
          <div className="md:w-1/2 flex flex-col space-y-2 gap-5 py-10 px-2 text-center md:text-left justify-center">
            ...
            Nous offrons des solutions d’éclairage innovantes et luxueuses avec des lampes de table conçues pour inspirer le raffinement et l’exclusivité dans chaque espace. Spécialisés dans la fourniture de lampes élégantes pour les hôtels et restaurants, nous sublimons les ambiances et apportons une touche d’élégance moderne. Grâce à une qualité supérieure et des designs uniques, nous garantissons un éclairage qui capte les regards et crée une impression durable. Que vous cherchiez à ajouter de la chaleur à votre restaurant ou à rehausser l’attractivité de votre hôtel, nous sommes votre partenaire idéal pour marier beauté pratique et raffinement exquis.
            </p>
