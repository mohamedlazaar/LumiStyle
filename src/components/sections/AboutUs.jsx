...
function AboutUs() {
  ...
  return (
<section className="py-20 overflow-hidden bg-gray-50 sm:pt-16 2xl:pt-16">
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid items-center grid-cols-1 md:grid-cols-2">

            <div>
                <h2 className="text-3xl font-bold leading-tight text-black  sm:text-4xl lg:text-5xl">À propos de nous
                </h2>
                <p className="max-w-lg mt-3 text-base leading-relaxed text-gray-600  md:mt-8">
                ...
                <p className="mt-4 text-xl text-gray-600  md:mt-8">
                    ...
                    <br className="block sm:hidden" />Ask me on <a href={whatsappMessage} target='_blank'
                        className="transition-all duration-200 text-yellow-500  hover:text-yellow-600  hover:underline">WhatsApp</a>
                </p>
            </div>

            <div className="relative">
                {/* <img className="absolute inset-x-0 bottom-0  -translate-x-1/2 left-1/2 fill-yellow-500" src="https://img.freepik.com/free-photo/top-view-yellow-circle-with-colorful-geometric-shapes_23-2148209935.jpg?t=st=1728488211~exp=1728491811~hmac=a2af4ae34ba6ce4125d5c16186ac81362c33b6bbd445c4d4e98e463ceeacb3c7&w=1480" alt="" /> */}

                <img className="relative w-full xl:max-w-lg xl:mx-auto 2xl:origin-bottom 2xl:scale-110 rounded-full" src={logo} alt="" />
            </div>
