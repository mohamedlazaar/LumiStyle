...
function AllProducts({ data }) {
  return (
    <div className='pb-5'>
      ...
      <div key={index} class="relative flex flex-col text-gray-700 bg-white shadow-md bg-clip-border rounded-xl ">
      <div class="relative mx-4 mt-4 overflow-hidden text-gray-700 bg-white bg-clip-border rounded-xl">
          <img
              ...
              alt={collection.title} class="object-cover w-full h-full" />
      </div>
      <div class="py-6 px-3">
          <div class="flex items-center justify-center mb-2">
              <p class="block font-sans text-base antialiased font-medium leading-relaxed text-blue-gray-900 text-center">
                  {collection.title}
              </p>
          ...
          <p class="block font-sans text-base antialiased font-normal  leading-normal text-gray-700 opacity-75 text-center">
              {collection.price}
          </p>
      </div>
      <div class="pb-5 pt-0 mx-auto">
          <Link to={`/produits/${collection.id}`}
